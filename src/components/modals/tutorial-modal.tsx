    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl h-[90vh] flex flex-col p-0">
        <DialogHeader className="p-4 border-b">
          ...
          <DialogDescription>
            Answer the questions below to complete the tutorial. The Chief will review your responses.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter className="p-4 border-t bg-slate-50 rounded-b-lg">
          ...
          <Button className="bg-primary hover:bg-primary/90" onClick={handleSubmit} disabled={!allAgreed || isLoading}>
