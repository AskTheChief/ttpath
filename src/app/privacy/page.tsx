    ...
    <div className="container mx-auto p-4 sm:p-6 lg:p-8 max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p>
            For more information about our privacy practices or if you have questions, please contact us by email at <a href="mailto:support@ttpath.com" className="text-primary hover:underline">support@ttpath.com</a>.
          </p>
        </section>
      </div>
    </div>
