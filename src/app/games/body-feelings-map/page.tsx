            ...
            <Card className="md:col-span-2">
                ...
                <CardContent>
                    <div className="relative w-full max-w-md mx-auto aspect-[2/3] cursor-pointer">
                        ...
                        >
                           <path 
                              d="M100,20 C113.8,20 125,31.2 125,45 C125,58.8 113.8,70 100,70 C86.2,70 75,58.8 75,45 C75,31.2 86.2,20 100,20 Z M 100,70 L 100,160 M 100,160 L 125,280 L 115,280 L 100,190 L 85,280 L 75,280 L 100,160 M 100,100 L 180,150 L 185,140 L 105,95 M 100,100 L 20,150 L 15,140 L 95,95"
                              fill="none" 
                              stroke="currentColor" 
                              strokeWidth="2"
                           />
