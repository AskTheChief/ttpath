...
function LiveTicker() {
  ...
  useEffect(() => {
    ...
    const allTickers = [
      // Trading & Finance
      'FOMO','HODL','YOLO','REKT','WAGMI','NGMI','BTFD','GTFO','LMAO','ROFL','YEET','BRUH','LOLZ',
      'OMFG','STFU','IDGAF','IYKYK','TLDR','IMHO','AFAIK','ROTFL','PMSL','GTFOH','SNAFU','FUBAR',
      'TGIF','ASAP','FWIW','ICYMI','IIRC','YMMV','IANAL','NSFW','GOAT','MOFO','BAMF','DILF',
      // Fake Corporate
      'DERP','HURR','DURR','BONK','BRRR','SPLAT','THUD','OOPS','YIKES','WELP','SHEESH','BRUH2',
      'SKRT','DRIP','BUSN','SLAY','VIBE','RIZZ','SIGMA','ALPHA','BETA','DELTA','GAMMA','THETA',
      'KAPPA','OMEGA','ZETA','IOTA','PHI','PSI','CHI','RHO','TAU',
      // Sounds & Reactions
      'BONK2','BOOP','BEEP','BLEEP','BLORP','SPLSH','GLUG','BURP','HICC','YAWN','SNOR','HONK',
      'TOOT','FART','BELCH','WHEEZ','GASP','GULP','SLURP','CHOMP','MUNCH','CRUNCH','SNAP2','POP2',
      'FIZZ','SIZZL','WHOMP','CLANG','THWK','KABOOM','KAPOW','BLAMM','WHAMM','ZONK','PLONK',
      // Internet & Memes
      'PEPE','DOGE','SHIB','CHAD2','KAREN','BOOMER','ZOOMER','COOMER','DOOMER','BLOOMER','GAMER',
      'SIMP','BASED','CRINGE','COPE2','SEETHE','MALD','RATIO','DELULU','SUSSY','AMOGUS','SKSKS',
      'PERIODT','BESTIE','GIRLBS','CHEUGY','LOWKEY','HIGHKY','NOCAP','FRFR','DEADSS','ISTG',
      // Food Adjacent
      'CHONK','THICC','SMOL','LORGE','FLOOF','BLEP','MLEM','BORK','HECKIN','DOGGO','CATTO','BIRB',
      'SNEK','MONKE','FISHE','SHRIMP2','BEAN','LOAF','CHONKR','FLOOFY','HECCN','PUPPR','KITTN',
      // Chaos
      'AAAAA','REEEE','OOGAA','BOOGAA','ZOINK','JINKYS','RUHRO','CRIKEY','BLIMEY','YOWZA','JUMPIN',
      'EGADS','GADZK','SACRE','BLEU','MERDE','CARAMBA','AIIYAH','WOWZA','GOLLY','JEEPRS','SHUCKS',
      // Greek Letters as Stocks
      'LAMDA','EPSILON','UPSILN','SIGMAA','OMICR','NUSYM','MUSYM','XISYM','PISYM','ETASYM',
      // More Trading Slang
      'BAGHD','PAPHR','DIAMD','SQUEEZE','RUGPL','APESH','TENDIES','MOONSH','LAMBO2','WENMO',
      'WENLAMB','GMEEE','BBYYY','AMCCC','NKLA2','PLTR2','SPCE2','WISH2','CLOV2','SOFI2',
      // Absurd Combos
      'CHZBR','PIZZ4','TACOB','BURRT','HOTDG','CORNDOG','PRETL','NACHZ','QUESO','CHIMMY',
      'FLAUT','ENCHD','TAMLE','PUPSA','AREPA','EMPND','GYRO','FLAFL','SHWRM','KEBAB',
      'HUMMS','BABAG','TZIKI','DOLMA','PIEROG','BORSHT','BLINI','KVASS','WODKA','SCHNAPPS',
      // Tech Bro
      'DISRPT','SYNRGY','PIVOTR','SCALER','GRWTHK','HACKR','MVPPP','AGILE','SCRUM','KANBN',
      'DEVOPS','CICD','SAAS','PAAS','IAAS','BAAS','DAAS','XAAS','MICROSVR','DOCKER','KUBNTS',
      'MONGO','REDIS','NGINX','REACT','NEXTJS','SVELTR','RUSTLG','GOLANGG','PYTH0N','JAVAS',
      // Wellness & Woo
      'CHAKRA','NAMSTE','ZENAF','KARMAA','DHARMA','MANTRA','MUDRA','ASANA','PRANAA','AURA',
      'VIBES2','MERKBA','KUNDALN','SATORI','NIRVNA','BODHI','SANGHA','SUTRA','TANTRA','YANTRA',
      // Random Objects
      'SPORK','CROCS','SNUGG','ONESIE','BLANKY','BINKY','SIPPY2','NAPPY','DUCKIE','TEDDY',
      'PLUSHI','FIDGT','SLIME2','PUTTY','DOUGH','CLAY','CRAYOLA','SHARPIE','STIKEE','RUBIKS',
      'JENGA','UNO','YAHTZ','BOGGLE','SORRY','CLUE','RISK2','LIFE2','MONOPOL','CATAN',
      // Exclamations
      'WOWEE','NEATO','TUBULR','GNARLY','RADCL','BODACS','EXCELL','BRILL','FANTSC','MAGNFC',
      'SPLNDD','SUPERB','AMAZNG','INCREDL','OUTSDNG','PHENMNL','STUPNDS','TREMDS','COLSSL',
      'ENORMUS','GIGANC','MASSVV','TITANIC','EPICCC','LEGENDR','MYTHCL','DIVINEE',
    ];
